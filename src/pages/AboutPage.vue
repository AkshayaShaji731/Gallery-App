<template>
  ...
  <p class="text-white text-body-1 text-justify">
    An image is a visual representation of something, while a digital image is a
    binary representation of visual data. These images can take the form of
    ...
    visibly resolved. Resolution units are tied to physical dimensions, angular
    subtense or the size of a picture (television lines, or TVL).</p>
</template>
